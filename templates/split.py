...
# load dataset
df = pd.read_csv('D:\ปี 4 projectจบ\Dataset/dataobesity-1.csv',encoding='cp1252') #โรคอ้วน
...
#df = pd.read_csv('D:\ปี 4 projectจบ\Dataset/diesease-of-hyprtlipidemia-1.csv',encoding='cp1252') #โรคไขมัน ยังวัดค่าความถูกต้องไม่ได้
